...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000176d9d71000000000f1527a8(
...
class phpbbtemplatetwiglexer_00000000176d9d71000000000f1527a8 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a6e102351e0a172452311 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a6e102351e10432660555 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a6e102351df6867714963 = array(
    ...
    {
        $this->initializer5a6e102351e10432660555 && ($this->initializer5a6e102351e10432660555->__invoke($valueHolder5a6e102351e0a172452311, $this, 'set_environment', array('env' => $env), $this->initializer5a6e102351e10432660555) || 1) && $this->valueHolder5a6e102351e0a172452311 = $valueHolder5a6e102351e0a172452311;

        return $this->valueHolder5a6e102351e0a172452311->set_environment($env);
    }
    ...
    {
        $this->initializer5a6e102351e10432660555 && ($this->initializer5a6e102351e10432660555->__invoke($valueHolder5a6e102351e0a172452311, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a6e102351e10432660555) || 1) && $this->valueHolder5a6e102351e0a172452311 = $valueHolder5a6e102351e0a172452311;

        return $this->valueHolder5a6e102351e0a172452311->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a6e102351e10432660555 && ($this->initializer5a6e102351e10432660555->__invoke($valueHolder5a6e102351e0a172452311, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a6e102351e10432660555) || 1) && $this->valueHolder5a6e102351e0a172452311 = $valueHolder5a6e102351e0a172452311;

        return $this->valueHolder5a6e102351e0a172452311->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a6e102351e10432660555 = $initializer;
    }
    ...
    {
        $this->initializer5a6e102351e10432660555 && ($this->initializer5a6e102351e10432660555->__invoke($valueHolder5a6e102351e0a172452311, $this, '__get', array('name' => $name), $this->initializer5a6e102351e10432660555) || 1) && $this->valueHolder5a6e102351e0a172452311 = $valueHolder5a6e102351e0a172452311;

        if (isset(self::$publicProperties5a6e102351df6867714963[$name])) {
            return $this->valueHolder5a6e102351e0a172452311->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a6e102351e0a172452311;
    ...
    {
        $this->initializer5a6e102351e10432660555 && ($this->initializer5a6e102351e10432660555->__invoke($valueHolder5a6e102351e0a172452311, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a6e102351e10432660555) || 1) && $this->valueHolder5a6e102351e0a172452311 = $valueHolder5a6e102351e0a172452311;
    ...
    {
        $this->initializer5a6e102351e10432660555 && ($this->initializer5a6e102351e10432660555->__invoke($valueHolder5a6e102351e0a172452311, $this, '__isset', array('name' => $name), $this->initializer5a6e102351e10432660555) || 1) && $this->valueHolder5a6e102351e0a172452311 = $valueHolder5a6e102351e0a172452311;
    ...
    {
        $this->initializer5a6e102351e10432660555 && ($this->initializer5a6e102351e10432660555->__invoke($valueHolder5a6e102351e0a172452311, $this, '__unset', array('name' => $name), $this->initializer5a6e102351e10432660555) || 1) && $this->valueHolder5a6e102351e0a172452311 = $valueHolder5a6e102351e0a172452311;
    ...
    {
        $this->initializer5a6e102351e10432660555 && ($this->initializer5a6e102351e10432660555->__invoke($valueHolder5a6e102351e0a172452311, $this, '__clone', array(), $this->initializer5a6e102351e10432660555) || 1) && $this->valueHolder5a6e102351e0a172452311 = $valueHolder5a6e102351e0a172452311;

        $this->valueHolder5a6e102351e0a172452311 = clone $this->valueHolder5a6e102351e0a172452311;
    }

    public function __sleep()
    {
        $this->initializer5a6e102351e10432660555 && ($this->initializer5a6e102351e10432660555->__invoke($valueHolder5a6e102351e0a172452311, $this, '__sleep', array(), $this->initializer5a6e102351e10432660555) || 1) && $this->valueHolder5a6e102351e0a172452311 = $valueHolder5a6e102351e0a172452311;

        return array('valueHolder5a6e102351e0a172452311');
    }
    ...
    {
        return $this->initializer5a6e102351e10432660555;
    }
    ...
    {
        return $this->initializer5a6e102351e10432660555 && ($this->initializer5a6e102351e10432660555->__invoke($valueHolder5a6e102351e0a172452311, $this, 'initializeProxy', array(), $this->initializer5a6e102351e10432660555) || 1) && $this->valueHolder5a6e102351e0a172452311 = $valueHolder5a6e102351e0a172452311;
    }
    ...
    {
        return null !== $this->valueHolder5a6e102351e0a172452311;
    }
    ...
    {
        return $this->valueHolder5a6e102351e0a172452311;
    }
