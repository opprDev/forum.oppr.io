...
/* posting_layout.html */
class __TwigTemplate_2fdb03e9d91e2b8ff66f507a087c4d0f21c96ffe923089a38f9ff3829d4e51bc extends Twig_Template
{
...
\t</div>
      ";
        ...
        if (($context["S_SHOW_ATTACH_BOX"] ?? null)) {
            ...
            $this->loadTemplate("posting_attach_body.html", "posting_layout.html", 60)->display($context);
            if ($namespace) {
                $this->env->setNamespaceLookUpOrder($previous_look_up_order);
            }
        }
        ...
        if ((($context["S_SHOW_POLL_BOX"] ?? null) || ($context["S_POLL_DELETE"] ?? null))) {
            ...
            $this->loadTemplate("posting_poll_body.html", "posting_layout.html", 62)->display($context);
            if ($namespace) {
                $this->env->setNamespaceLookUpOrder($previous_look_up_order);
            }
        }
...
\t  <div class=\"panel-body\">
      ";
            ...
            $this->loadTemplate("posting_topic_review.html", "posting_layout.html", 73)->display($context);
            if ($namespace) {
                $this->env->setNamespaceLookUpOrder($previous_look_up_order);
            }
            // line 74
...
";
        ...
        $this->loadTemplate("overall_footer.html", "posting_layout.html", 82)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
    }
    ...
    {
        return array (  309 => 82,  302 => 77,  297 => 74,  285 => 73,  281 => 71,  279 => 70,  271 => 64,  269 => 63,  254 => 62,  252 => 61,  238 => 60,  232 => 58,  219 => 57,  216 => 56,  210 => 53,  204 => 49,  190 => 48,  187 => 47,  175 => 40,  169 => 39,  164 => 37,  158 => 35,  154 => 34,  149 => 32,  145 => 30,  143 => 29,  140 => 28,  126 => 27,  123 => 26,  109 => 25,  106 => 24,  100 => 21,  96 => 20,  93 => 19,  91 => 18,  84 => 16,  81 => 15,  77 => 13,  63 => 12,  59 => 10,  57 => 9,  54 => 8,  46 => 6,  36 => 4,  34 => 3,  31 => 2,  19 => 1,);
    }
