...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'sitesplat.bbcore.admin_listener' => 'getSitesplat_Bbcore_AdminListenerService',
            'sitesplat.bbcore.listener' => 'getSitesplat_Bbcore_ListenerService',
            'sitesplat.service' => 'getSitesplat_ServiceService',
    ...
    /**
     * Gets the public 'sitesplat.bbcore.admin_listener' shared service.
     *
     * @return \sitesplat\BBCore\event\admin_listener
     */
    protected function getSitesplat_Bbcore_AdminListenerService()
    {
        return $this->services['sitesplat.bbcore.admin_listener'] = new \sitesplat\BBCore\event\admin_listener($this->get('config'), $this->get('dbal.conn'), $this->get('user'), $this->get('template'), './');
    }

    /**
     * Gets the public 'sitesplat.bbcore.listener' shared service.
     *
     * @return \sitesplat\BBCore\event\listener
     */
    protected function getSitesplat_Bbcore_ListenerService()
    {
        return $this->services['sitesplat.bbcore.listener'] = new \sitesplat\BBCore\event\listener($this->get('config'), $this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('controller.helper'), $this->get('template'), $this, './', 'php');
    }

    /**
     * Gets the public 'sitesplat.service' shared service.
     *
     * @return \sitesplat\service
     */
    protected function getSitesplat_ServiceService()
    {
        return $this->services['sitesplat.service'] = new \sitesplat\service($this->get('user'));
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000056b5e08500000000647cbc86(
...
class phpbbtemplatetwiglexer_0000000056b5e08500000000647cbc86 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a6e10ac378bb731286797 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a6e10ac378c1095864711 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a6e10ac378a9878370730 = array(
    ...
    {
        $this->initializer5a6e10ac378c1095864711 && ($this->initializer5a6e10ac378c1095864711->__invoke($valueHolder5a6e10ac378bb731286797, $this, 'set_environment', array('env' => $env), $this->initializer5a6e10ac378c1095864711) || 1) && $this->valueHolder5a6e10ac378bb731286797 = $valueHolder5a6e10ac378bb731286797;

        return $this->valueHolder5a6e10ac378bb731286797->set_environment($env);
    }
    ...
    {
        $this->initializer5a6e10ac378c1095864711 && ($this->initializer5a6e10ac378c1095864711->__invoke($valueHolder5a6e10ac378bb731286797, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a6e10ac378c1095864711) || 1) && $this->valueHolder5a6e10ac378bb731286797 = $valueHolder5a6e10ac378bb731286797;

        return $this->valueHolder5a6e10ac378bb731286797->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a6e10ac378c1095864711 && ($this->initializer5a6e10ac378c1095864711->__invoke($valueHolder5a6e10ac378bb731286797, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a6e10ac378c1095864711) || 1) && $this->valueHolder5a6e10ac378bb731286797 = $valueHolder5a6e10ac378bb731286797;

        return $this->valueHolder5a6e10ac378bb731286797->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a6e10ac378c1095864711 = $initializer;
    }
    ...
    {
        $this->initializer5a6e10ac378c1095864711 && ($this->initializer5a6e10ac378c1095864711->__invoke($valueHolder5a6e10ac378bb731286797, $this, '__get', array('name' => $name), $this->initializer5a6e10ac378c1095864711) || 1) && $this->valueHolder5a6e10ac378bb731286797 = $valueHolder5a6e10ac378bb731286797;

        if (isset(self::$publicProperties5a6e10ac378a9878370730[$name])) {
            return $this->valueHolder5a6e10ac378bb731286797->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a6e10ac378bb731286797;
    ...
    {
        $this->initializer5a6e10ac378c1095864711 && ($this->initializer5a6e10ac378c1095864711->__invoke($valueHolder5a6e10ac378bb731286797, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a6e10ac378c1095864711) || 1) && $this->valueHolder5a6e10ac378bb731286797 = $valueHolder5a6e10ac378bb731286797;
    ...
    {
        $this->initializer5a6e10ac378c1095864711 && ($this->initializer5a6e10ac378c1095864711->__invoke($valueHolder5a6e10ac378bb731286797, $this, '__isset', array('name' => $name), $this->initializer5a6e10ac378c1095864711) || 1) && $this->valueHolder5a6e10ac378bb731286797 = $valueHolder5a6e10ac378bb731286797;
    ...
    {
        $this->initializer5a6e10ac378c1095864711 && ($this->initializer5a6e10ac378c1095864711->__invoke($valueHolder5a6e10ac378bb731286797, $this, '__unset', array('name' => $name), $this->initializer5a6e10ac378c1095864711) || 1) && $this->valueHolder5a6e10ac378bb731286797 = $valueHolder5a6e10ac378bb731286797;
    ...
    {
        $this->initializer5a6e10ac378c1095864711 && ($this->initializer5a6e10ac378c1095864711->__invoke($valueHolder5a6e10ac378bb731286797, $this, '__clone', array(), $this->initializer5a6e10ac378c1095864711) || 1) && $this->valueHolder5a6e10ac378bb731286797 = $valueHolder5a6e10ac378bb731286797;

        $this->valueHolder5a6e10ac378bb731286797 = clone $this->valueHolder5a6e10ac378bb731286797;
    }

    public function __sleep()
    {
        $this->initializer5a6e10ac378c1095864711 && ($this->initializer5a6e10ac378c1095864711->__invoke($valueHolder5a6e10ac378bb731286797, $this, '__sleep', array(), $this->initializer5a6e10ac378c1095864711) || 1) && $this->valueHolder5a6e10ac378bb731286797 = $valueHolder5a6e10ac378bb731286797;

        return array('valueHolder5a6e10ac378bb731286797');
    }
    ...
    {
        return $this->initializer5a6e10ac378c1095864711;
    }
    ...
    {
        return $this->initializer5a6e10ac378c1095864711 && ($this->initializer5a6e10ac378c1095864711->__invoke($valueHolder5a6e10ac378bb731286797, $this, 'initializeProxy', array(), $this->initializer5a6e10ac378c1095864711) || 1) && $this->valueHolder5a6e10ac378bb731286797 = $valueHolder5a6e10ac378bb731286797;
    }
    ...
    {
        return null !== $this->valueHolder5a6e10ac378bb731286797;
    }
    ...
    {
        return $this->valueHolder5a6e10ac378bb731286797;
    }
